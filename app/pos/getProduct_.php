...
INNER JOIN tabpricedetail d ON p.productID = d.productID
WHERE p.productID = '$_GET[productID]' AND p.outletID = '$_SESSION[outletID]' AND p.status = 1 AND p.curStock != 0 AND d.priceID = 2");
