...
INNER JOIN muser u ON h.userID = u.userID WHERE h.status = '3' AND h.outletID = '$_SESSION[outletID]' ORDER BY h.lastChanged";
// $query = "SELECT h.preorderID,h.preorderNo,h.preorderDate,h.preorderPeriode,h.preorderAmount,p.total,m.methodName,u.fullname,h.lastChanged FROM tabpreorderheader h 
...
while ($row=mysql_fetch_array($res)){
    ...
    $nestedData[action] = "<a href='manage_preorder.php?orderID=$row[orderID]'>VIEW</a>";
