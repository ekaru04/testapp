...
$orderID = "PCA/END/$per/".str_pad($count,4,"0",STR_PAD_LEFT);
...
$countArr = count($productID);
	...
	if($status == 0){
		...
		$queryPayment = mysql_query("INSERT INTO tabpaymentorder(id,orderID,orderType,paymentType,paymentMethod,paymentAmount,dpp,VAT,discountPrice,total,promoID,isVoucher,voucherID,remarks,status,dateCreated,lastChanged) VALUES ('$paymentOrderID','$orderID','ENDORSEMENT-ORDER','DIRECT-PAYMENT','$paymentMethod','$paymentAmount','$dpp','$VAT','$discountPrice','$total','$promoID','$isVoucher','$voucherCode','$remarks',1,'$dateCreated','$lastChanged')");
